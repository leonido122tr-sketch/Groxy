  ...
  return (
    <div className="flex min-h-screen flex-col bg-black font-sans text-white pt-safe">
      <header className="border-b border-white/10">
        <div className="mx-auto max-w-5xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <h1 className="text-2xl font-bold truncate max-w-[70%]">Пристрой 2 стены</h1>
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-10 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold leading-tight">Пристрой 2 стены</h2>
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
          {(() => {
            // Те же значения, что на странице фундамента/стен/крыши: ручной итог из storage или авто-расчёт
          ...
          >
            ...
            {foundationValue != null && (
              <span className="text-xs font-normal opacity-90">
                {Number(foundationValue).toFixed(2).replace('.', ',')} м³
              </span>
            )}
          </button>
          <button
          ...
          >
            ...
            {(wo.wallsArea != null || wo.wallsVolume != null) && (
              <span className="text-xs font-normal opacity-90">
                {(wo.wallsArea ?? 0).toFixed(2).replace('.', ',')} м² · {(wo.wallsVolume ?? 0).toFixed(2).replace('.', ',')} м³
              </span>
            )}
          </button>
          <button
          ...
          >
            ...
            {roofValue != null && (
              <span className="text-xs font-normal opacity-90">
                {Number(roofValue).toFixed(2).replace('.', ',')} м²
              </span>
            )}
          </button>
              </>
