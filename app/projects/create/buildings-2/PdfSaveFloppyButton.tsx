  ...
  return (
    <>
      <div className="relative shrink-0">
        ...
        {showNameHint && (
          <div
            className="absolute top-full left-1/2 -translate-x-1/2 mt-2 z-50 px-3 py-2 rounded-lg bg-zinc-800 text-amber-400 text-xs whitespace-nowrap shadow-lg border border-white/10"
            role="status"
          >
