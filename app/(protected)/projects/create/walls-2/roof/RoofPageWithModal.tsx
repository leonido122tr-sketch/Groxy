        ...
        <header className="border-b border-white/8 bg-[#10161f]">
          <div className="mx-auto max-w-2xl px-4 py-3 sm:px-6">
            <div className="flex items-center justify-between gap-4">
              <BackButton
                fallbackHref="/projects/create/walls-2"
              ...
              <h1 className="text-xl font-semibold tracking-[-0.02em] text-white">Крыша</h1>
        ...
        <div className="mt-1 rounded-[22px] border border-white/10 bg-[#141a22] p-5 shadow-[0_6px_18px_rgba(0,0,0,0.18)]">
          <div className="space-y-5">
            <div>
              ...
              <div className="android-select text-sm">
            ...
            <div className="relative overflow-hidden rounded-[20px] border border-white/10 bg-[#10161f]">
              {onSchemaClick && (
                <button
                  type="button"
          ...
          <div className="android-panel mt-6 p-5">
            <EditableResultBlock
              plain
              label="Площадь крыши"
          ...
          {roofArea > 0 && (
            <div className="mt-4 space-y-4">
              ...
              <EditableResultBlock plain label="Стропила (50×150 мм)" calculatedValue={Math.round(rafterVolume * 100) / 100} overrideValue={roofOverrides.roofRaftersVolume} unit="м³" onOverride={(v: number | undefined) => setRoofOverrides((prev) => ({ ...prev, roofRaftersVolume: v }))} />
              <EditableResultBlock plain label="Стропила (50×150 мм)" calculatedValue={Math.round(rafterVolume * 100) / 100} overrideValue={roofOverrides.roofRaftersVolume} unit="м³" onOverride={(v: number | undefined) => setRoofOverrides((prev) => ({ ...prev, roofRaftersVolume: v }))} />
              <EditableResultBlock plain label="Прогоны (40×100 мм)" calculatedValue={Math.round(purlinVolume * 100) / 100} overrideValue={roofOverrides.roofPurlinVolume} unit="м³" onOverride={(v: number | undefined) => setRoofOverrides((prev) => ({ ...prev, roofPurlinVolume: v }))} />
              <EditableResultBlock plain label="Обрешётка (25×100 мм)" calculatedValue={Math.round(battenVolume * 100) / 100} overrideValue={roofOverrides.roofBattenVolume} unit="м³" onOverride={(v: number | undefined) => setRoofOverrides((prev) => ({ ...prev, roofBattenVolume: v }))} />
